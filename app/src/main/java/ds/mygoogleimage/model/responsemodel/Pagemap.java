...
public class Pagemap {
    ...
    @SerializedName("financialquote")
    @Expose
    private List<Financialquote> financialquote = null;
    ...
    public List<Financialquote> getFinancialquote() {
        return financialquote;
    }

    public void setFinancialquote(List<Financialquote> financialquote) {
